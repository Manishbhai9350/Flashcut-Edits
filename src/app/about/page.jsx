...
const brands = [
  ...
  { id: 6, src: "/brands/koparo.png", alt: "Koparo" },
];
        ...
        <section className="relative z-20 bg-white text-[#0d1117] py-32 px-6 md:px-20">
          <div className=" mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-80 pop  mx-auto leading-relaxed">
              We're not just video editors – we're visual storytellers
              passionate about transforming your ideas into captivating content
              that resonates with your audience.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/services"
                className="px-8 py-3 text-white rounded-lg transition-all duration-300 cursor-pointer font-medium bg-gradient-to-r from-blue-500 to-pink-500 text-xl hover:opacity-80"
              >
                Our Portfolio
              </Link>
              <Link
                ...
                target="_blank"
                className="px-8 py-3 border-2 border-gray-300 text-[#0d1117] rounded-lg hover:border-blue-500 hover:text-blue-500 transition-all duration-300 cursor-pointer font-medium text-xl"
              >
                Get In Touch
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-lg opacity-80 leading-relaxed">
                  <p>
                    Founded in 2024, FlashCut Edits began as a small creative
                    studio with a big dream: to democratize professional video
                    editing and make it accessible to creators worldwide.
                  </p>
                  <p>
                    What started as a passion project has evolved into a
                    full-service creative agency trusted by clients globally.
                    We've edited countless minutes of content, generated
                    millions of views, and helped brands tell their stories.
                  </p>
                  <p>
                    Today, we're proud to be at the forefront of digital content
                    creation, combining cutting-edge technology with timeless
                    storytelling principles to deliver extraordinary results.
                  </p>
                </div>
              </div>
        ...
        <section className="bg-white text-gray-800 py-16 px-6 md:px-20">
          <div className=" mx-auto text-center">
            ...
            <p className="text-gray-500  mx-auto mb-14">
              Our leadership team brings together diverse expertise to guide
              FlashCut Edits towards excellence in video editing and client
              satisfaction.
            </p>
            ...
            <div className="flex justify-center items-center gap-8">
              ...
              <div className="group max-w-[500px] bg-white border border-gray-200 shadow-lg rounded-2xl p-6 text-center transition duration-300 hover:bg-[#0d1117] hover:border-[#0d1117]">
                ...
                <p className="text-blue-500 font-medium mb-3 group-hover:text-blue-400 transition">
                  Founder
                </p>
                <p className="text-gray-600 text-sm leading-relaxed group-hover:text-white/80 transition">
                  The visionary Founder of FlashCut Edits, leads the agency with
                  a deep passion for content creation and innovation in digital
                  storytelling.
                </p>
              </div>
  ...
  <p className="text-gray-600 text-sm leading-relaxed group-hover:text-white/80 transition">
    Ensures smooth coordination across departments, keeping every project aligned, efficient, and on schedule.
            ...
            <p className="text-gray-500 capitalize  mx-auto mt-14">
              20+ more talented team members working behind the scenes —
              bringing creativity, speed, and precision to every project.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white text-[#0d1117] py-20 px-6 md:px-20">
          <div className=" mx-auto text-center">
            ...
            <p className="text-lg opacity-80 mb-12  mx-auto leading-relaxed">
              Our core values shape everything we do, from the way we approach
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="group bg-white border border-gray-200 shadow-lg rounded-2xl p-8 text-center transition duration-300 hover:bg-[#0d1117] hover:border-[#0d1117] hover:shadow-2xl">
                ...
                <h4 className="text-xl font-bold mb-3 group-hover:text-white transition">
                  Passion
                </h4>
                <p className="text-gray-600 group-hover:text-white/80 transition">
                  We pour our heart into every project, treating your content as
                  if it were our own.
                </p>
              </div>
              ...
              <div className="group bg-white border border-gray-200 shadow-lg rounded-2xl p-8 text-center transition duration-300 hover:bg-[#0d1117] hover:border-[#0d1117] hover:shadow-2xl">
                ...
                <p className="text-gray-600 group-hover:text-white/80 transition">
                  We never settle for good enough. Every frame is crafted with
        ...
        <section className="bg-gray-50 text-[#0d1117] py-16 px-6 md:px-20">
          <div className=" mx-auto text-center">
            ...
            <p className="text-gray-500  mx-auto mb-14">
              From startups to Fortune companies, we've helped brands across
              industries create compelling video content that drives results.
            </p>
